...
import com.needblood.LoginActivity;
import com.needblood.MainActivity;
import com.needblood.R;
import com.needblood.SignupActivity;
...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnChangeEmail =  root.findViewById(R.id.change_email_button);
        btnChangePassword =  root.findViewById(R.id.change_password_button);
        btnSendResetEmail =  root.findViewById(R.id.sending_pass_reset_button);
        btnRemoveUser =  root.findViewById(R.id.remove_user_button);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(
                                                getActivity(), "Your profile is deleted:( Create a account now!", Toast.LENGTH_SHORT).show();
